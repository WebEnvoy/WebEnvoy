...
| Grant Wire Contract V1 (v1.4) | [grant-wire-contract-v1.md](../specs/grant-wire-contract-v1.md) | recovery、SKILL/file scope、Provider preference、`scope_semantics`、owner一次确认、严格 reader、撤销/过期与 idempotency 语义。 |
