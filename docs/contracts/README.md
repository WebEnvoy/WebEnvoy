...
| Profile Environment V1 | [profile-environment-v1.md](../specs/profile-environment-v1.md) | configured／effective／pending／observed／drift、Provider／设备／网络环境 owner、历史 Camoufox 连续性、变更、迁移和验证语义；不代表当前 Camoufox launch/support。 |
