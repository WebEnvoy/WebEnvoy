...
| Profile Environment V1 | [profile-environment-v1.md](../specs/profile-environment-v1.md) | configured／effective／pending／observed／drift、Provider／设备／网络环境 owner、多 Provider 选择、连续性、变更、迁移和验证语义。 |
| Obscura Managed Provider Validation V1 | [obscura-managed-provider-validation-v1.md](../specs/obscura-managed-provider-validation-v1.md) | 固定 Obscura build、单连接 Driver、安全边界、支持事实、缺口与采用门槛。 |
| Obscura localStorage private schema v1 | [`obscura-local-storage-v1.schema.json`](../../services/harbor/packages/runtime-api/contracts/obscura-local-storage-v1.schema.json) | Harbor 私有、按 Profile/origin 隔离的有界 checkpoint 格式；严格版本、原子写盘、损坏 fail-closed，不向 Plugin／App 导出内容。 |
| Local owner Viewer frame v1 | [`viewer-frame-v1.schema.json`](../../services/harbor/packages/runtime-api/contracts/viewer-frame-v1.schema.json) | 同一原 Instance 的有界 PNG frame response、owner-only audience 与不留存边界；输入继续由 session、viewer/frame ref、ControlLease 和 receipt 约束。 |
