...
| Observation Completeness and Target Identity V1 | [observation-targets-v1.md](../specs/observation-targets-v1.md) | 已接受的 #540 Page/Plugin 专门补充：`instance.snapshot` 完整性、同批续读、target identity 与局部失效；真实 schema/fixture 由实现 PR 建立。 |
