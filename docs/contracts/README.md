...
| Camoufox Native Provider Contract V1 | [camoufox-native-provider-contract-v1.md](../specs/camoufox-native-provider-contract-v1.md) | #504/#510 test-only Camoufox native snapshot、Playwright adapter、固定构件、Page relation、background create、safe-return close、reload 与 v2 native tab-handoff/CSS variant 及兼容/回滚边界。 |
