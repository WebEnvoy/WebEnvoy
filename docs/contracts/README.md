...
| Camoufox Native Provider Contract V1 | [camoufox-native-provider-contract-v1.md](../specs/camoufox-native-provider-contract-v1.md) | #504 test-only Camoufox native snapshot、Playwright adapter、固定构件、Page relation、background create、safe-return close、reload 适配及兼容/回滚边界。 |
