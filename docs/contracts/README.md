...
| Observation Completeness and Target Identity V1 | [observation-targets-v1.md](../specs/observation-targets-v1.md), [`harbor-observation-targets-request.schema.json`](../../packages/schemas/schemas/harbor-observation-targets-request.schema.json), [`harbor-observation-targets.schema.json`](../../packages/schemas/schemas/harbor-observation-targets.schema.json), [new request fixture](../../packages/schemas/fixtures/harbor-observation-targets-request.fixture.json), [continuation fixture](../../packages/schemas/fixtures/harbor-observation-targets-request-continuation.fixture.json), [response fixture](../../packages/schemas/fixtures/harbor-observation-targets.fixture.json), [request invalid fixtures](../../packages/schemas/invalid-fixtures/harbor-observation-targets-request.invalid.fixture.json), [response invalid fixtures](../../packages/schemas/invalid-fixtures/harbor-observation-targets.invalid.fixture.json) | 已接受的 #540 Page/Plugin 专门补充：`instance.snapshot` 完整性、同批续读、target identity、局部失效与可执行正反 schema/fixture。 |
