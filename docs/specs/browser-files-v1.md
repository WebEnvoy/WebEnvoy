...
> 依据：当前 canonical v1.6、ADR0012、Browser Runtime Capabilities V1 §10、现有 Page/Navigation、Grant/Plugin/Run 合同。S0 接受不自动改变本 v1.1 冻结合同、实现范围或既有验收证据；本文件不扩大完整 V1，也不将全部 Files 组压缩成本切片。
