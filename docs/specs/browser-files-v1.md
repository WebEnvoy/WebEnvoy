...
以下记录对应正式测试安装（构建时仓库 `d1ee7b6f7356f24260bd922891b4813b05b2ef61`、tree `121abfa964af6c9c6353892f69ce76404fb47442`），不把临时验收脚本或测试客户端当作产品状态。机器可读的最小 provenance/hash 摘要持久化于 [`docs/verification/browser-files-v1-installed-live-v1.json`](../verification/browser-files-v1-installed-live-v1.json)；下列临时路径是现场原件定位，不是唯一事实来源：
...
- 正式安装为 `/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/WebEnvoy 523 Formal v4.app`，独立 data root 为同目录 `data`，浏览器资产为同目录 `browser/Camoufox.app`；安装 status digest 为 `e10b2038d9db30392b75615c9d41c222843c8851e67668e7a1e2a2158b2bbc5d`，已安装 SKILL SHA-256 为 `8b98d3c814402c72196d2fb0701229ca9ddf9b3744ddc774219dbae648ae88d9`。受控 live origin 为 `http://127.0.0.1:61253`，服务端 metrics 文件 SHA-256 为 `f26858fbf869bc427ec72fc5a3f78256d6cfd47bdaf07b93d38d149950eaa492`：`uploads=2`（均为正式 v4 PNG SHA-256 `0a64b890a8453691dda8c30b75b48f3d0723ceb9377ebabeba5812c034a1a2b3`）、`downloads=2`（均为 CSV SHA-256 `c66edb8c595edcc4b598dcf6aa20fc2a808b5ae6418a2be9dd77607057e60715`）、`unexpected=[]`。这里的 v4 PNG hash 与 G0 原始 PNG hash 不同，不能混写。
- 真实 Codex 线程 `01a09763-c8b6-73a0-ae9a-ad14315c0419` 经已安装 Plugin 完成唯一短闭环：读取同一原任务页、`file.upload` 一次、重新观察/读取实际 receipt、同页 `file.download` 一次并 query；上传 Run 为 `managed-043c7f5c3506391e22b579d0b5bf1408151248b2200f451aa57df021d434639f`，下载 Run 为 `managed-5782a34815662228ca076ea59a7bb79c9cf46bd0372acf35283c37f75951463b`，下载输出 `attachment:runtime/173125aa-e932-46f8-9734-52eeff3b92c8`，15B，SHA-256 `c66edb8c595edcc4b598dcf6aa20fc2a808b5ae6418a2be9dd77607057e60715`；owner 独立 export 同 hash。原 Run query 未重放、服务端计数未增加。记录：`/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/real-codex-final-v4-continuation.txt`（SHA-256 `c6ed3c904922f862a91a123b67ba6d5f7a4e88d0ea51448677b00777d10c86a7`）。
- 确定性 installed/client 验收各门均通过：fresh observe 只用稳定 `page_id`，handoff slice 通过旧 target stale/fresh observe (`/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/handoff-slice-v4-evidence.json`，SHA-256 `a1e3018289f465ce91714d15110408d4565ca6939a21ec7ef9d67fab4ae1f8c1`)；响应丢失续跑通过 upload/download 各一次、query 原 Run 不重放、owner export/overwrite/symlink/agent-owner-path 边界、材料 revoke、Context stop/Runtime restart 持久化与 Grant revoke (`/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/deterministic-acceptance-v4-resume2-evidence.json`，SHA-256 `73dceda318152d8313a6558aedbb6fc62e54a6dba945e78e465a376ae0d07ee4`；`/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/persistence-final-v4-evidence.json`，SHA-256 `ee10ab79469912f2c7043991e2a5401ac5beae52be4aeda5f10e56ff5619327b`)。响应丢失后的页面 receipt 首次等待未由外部 metrics 轮询推进，正式 `instance.read`/`snapshot` 后同一既有 upload 才完成 Page 事件队列；该首反例和诊断保留于 `/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/deterministic-acceptance-v4-fifth-upload-metrics-timeout.json`（SHA-256 `e50267067c0abcbcb5c51bbacfafb49f6304586297fb433fa928c1719166d922`）及 `/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/diagnose-upload-drop-v4-evidence.json`（SHA-256 `741f6e3e8c9f577faf38ca57c294f7b3415fc56e256f97134b318a5cd279572c`），无 upload 重放。wait parser 离线形状/唯一 key selftest 通过 (`/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/deterministic-acceptance-v4-selftest-evidence.json`，SHA-256 `826add95d937ae193114ec51cecd3ec7bc525d607cdf4878a01e637319e37587`)。
- 本轮 v4 四个测试 Grant（`grant:d4847b4d-b75d-4358-8e90-920563fddd86`、`grant:28bef3d9-491d-4da7-8283-8e9048590119`、`grant:43d681b8-7535-4dc2-be02-943ac73ece8f`、`grant:dd81b7b2-6290-4ca6-8517-56b347cb53b3`）均已 owner revoke 且 readback 有 `revoked_at`；旧 v3 data root 中两个曾 active 的 candidate Grant `grant:f5c9fb66-ad10-44b9-a7ea-e72ec0206b03`、`grant:86530f73-e82d-4171-be75-a191aa7c36ac` 亦已 revoke，最终 `active_after=[]`。v4/v3 清理记录分别在 `/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/persistence-final-v4-evidence.json` 和 `/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/v3-grant-cleanup-evidence.json`（SHA-256 `9aacee73796435f82706408bc32364a0d1971d8aec0980ad260e8a9675048dac`）；正式 v4、v3 任务进程均已由其 `webenvoy stop --data-dir` 停止，Profile、安装包和规定失败/验收材料保留。
