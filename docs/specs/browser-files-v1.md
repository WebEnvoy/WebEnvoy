...
以下记录对应最终正式测试安装（构建时仓库 `f0fca26e3dfd24313e20aff39309f174b6a5cb59`、tree `2518e2cf2ab94c380e342452e4fef857b01d2a01`），不把临时验收脚本或测试客户端当作产品状态。机器可读的最小 provenance/hash 摘要持久化于 [`docs/verification/browser-files-v1-installed-live-v1.json`](../verification/browser-files-v1-installed-live-v1.json)；下列临时路径是现场原件定位，不是唯一事实来源：
...
- 最终安装为 `/private/tmp/webenvoy-523-final-v3.w4lJN4/WebEnvoy 523 Final v3.app`，独立 data root 为 `/private/tmp/webenvoy-523-final-agent-v3/data`；安装 status asset digest 为 `f0d5755997ed683f66a297930fccf0dff055598108d3d81741350c0283917142`，agent manifest SHA-256 为 `ada0ee12d8b83ab6007fe2c2418b5ee6ec056b58a492875875747b976db955d3`，已安装 SKILL SHA-256 为 `8b98d3c814402c72196d2fb0701229ca9ddf9b3744ddc774219dbae648ae88d9`。受控 live origin 为 `http://127.0.0.1:61349`，服务端 metrics 文件为 `/private/tmp/webenvoy-523-final-agent-v3/site/metrics.json`（SHA-256 `83bfd549f9a29f62b39da1de1adc05d4c257656fe18ccf56fbd0d3e48e95c8de`）：`uploads=1`（PNG SHA-256 `0a64b890a8453691dda8c30b75b48f3d0723ceb9377ebabeba5812c034a1a2b3`）、`downloads=1`（CSV SHA-256 `3b324f87f403ae14797d252944a9452b8b0f6d58871cec4ad361cc4ccf04e066`）、`unexpected=[]`。这里的 installed PNG hash 与 G0 原始 PNG hash 不同，不能混写。
- 真实 Codex 线程/session `01a097f6-ed4b-7370-94a6-387f461e85fa` 使用最终已安装 Plugin 完成唯一短闭环：fresh `page.list`/`instance.observe`/`instance.snapshot` 后，`file.upload` 一次、fresh snapshot/read 确认实际 receipt、同页 `file.download` 一次；上传 Run 为 `managed-2f12fafca250ab4b91fff730f8b6191934cab4d1135fbf0c01eeaaf8232f9512`，下载 Run 为 `managed-95e706421155677e78fb6f8ed3e116949451e32a43d61a165e59d1d08dcf8403`，下载输出 `attachment:runtime/dabb7354-5c61-4d0f-a94f-531c0b9b2d83`，21B，SHA-256 `3b324f87f403ae14797d252944a9452b8b0f6d58871cec4ad361cc4ccf04e066`；owner 独立 export `/private/tmp/webenvoy-523-final-agent-v3/agent-owner-export.csv` 同 hash。页面 receipt 为 `PNG received: 0a64b890a8453691dda8c30b75b48f3d0723ceb9377ebabeba5812c034a1a2b3`；原 Run query 未重放、服务端计数未增加。完整 MCP 调用及结果保留在 `/private/tmp/webenvoy-523-final-agent-v3/codex-resume/sessions/2026/09/13/rollout-2026-09-13T07-32-17-01a097f6-ed4b-7370-94a6-387f461e85fa.jsonl`（SHA-256 `c6fdfaa258023bc2c4e21ddd008fdf472a0afb1ba8afd7f30bcab4f658309e2b`）。
- 确定性 installed/client 验收各门均通过，最终安装 provenance 为本节开头的 f0fca26/tree 2518e2：fresh observe 只用稳定 `page_id`，handoff slice 通过旧 target stale/fresh observe (`/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/handoff-slice-v4-evidence.json`，SHA-256 `a1e3018289f465ce91714d15110408d4565ca6939a21ec7ef9d67fab4ae1f8c1`)；响应丢失续跑通过 upload/download 各一次、query 原 Run 不重放、owner export/overwrite/symlink/agent-owner-path 边界、材料 revoke、Context stop/Runtime restart 持久化与 Grant revoke (`/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/deterministic-acceptance-v4-resume2-evidence.json`，SHA-256 `73dceda318152d8313a6558aedbb6fc62e54a6dba945e78e465a376ae0d07ee4`；`/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/persistence-final-v4-evidence.json`，SHA-256 `ee10ab79469912f2c7043991e2a5401ac5beae52be4aeda5f10e56ff5619327b`)；这些现场材料对应最终 f0 安装复核，机器可读的门清单、source/tree、status/manifest hash 固化于 `docs/verification/browser-files-v1-installed-live-v1.json`。final head 的 Playwright 1.60 公共可见性 API 适配由 13 项 focused driver tests、Harbor 339 项测试（338 pass、1 Windows-only skip）及上述真实 Agent upload/download 复核，未改变文件归属、下载生命周期或 owner 边界逻辑。响应丢失后的页面 receipt 首次等待未由外部 metrics 轮询推进，正式 `instance.read`/`snapshot` 后同一既有 upload 才完成 Page 事件队列；该首反例和诊断保留于 `/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/deterministic-acceptance-v4-fifth-upload-metrics-timeout.json`（SHA-256 `e50267067c0abcbcb5c51bbacfafb49f6304586297fb433fa928c1719166d922`）及 `/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/diagnose-upload-drop-v4-evidence.json`（SHA-256 `741f6e3e8c9f577faf38ca57c294f7b3415fc56e256f97134b318a5cd279572c`），无 upload 重放。wait parser 离线形状/唯一 key selftest 通过 (`/var/folders/zd/dh222wbn5bz92d2rg9p708pm0000gn/T/webenvoy-523-formal-v4.UGgMni/deterministic-acceptance-v4-selftest-evidence.json`，SHA-256 `826add95d937ae193114ec51cecd3ec7bc525d607cdf4878a01e637319e37587`)。
- 本轮最终 v3 三个测试 Grant（`grant:0e65d6b9-031a-4fd0-8e2c-7c4a05ddeb8d`、`grant:8a6a9ad0-e39e-4a38-8127-6ec1677286ef`、`grant:fb4bb1fc-748b-4da0-9e55-b7b6f6210dfa`）均已 owner revoke 且 readback 有 `revoked_at`；最终 readback 摘要为 `/private/tmp/webenvoy-523-final-agent-v3/access-list-final.json`（SHA-256 `2f9af20fa848eb21e3731a81fdd283accb024745e97683fb0d62da02c7a482eb`），`active_after=[]`。最终 runtime 已由 owner CLI `stop --data-dir` 停止，受控 site 由任务 PTY 停止，Profile、安装包、Agent rollout、G0 与首异常材料保留。

因此第8节 1–7 项在上述 exact installed/live 身份下均为 PASS；保留的 harness 顺序/CLI 路径和 Page event-loop 诊断为验收过程证据，不是产品失败或范围变更。
