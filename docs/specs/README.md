...
| [Page, Document and Navigation Runtime Contract V1](page-navigation-runtime-contract-v1.md) | [Runtime FR #497](https://github.com/WebEnvoy/WebEnvoy/issues/497) | 冻结同一 Instance 内多 Page、document generation、popup/opener、URL/origin authorization、redirect、关系异常与安全暂停语义。 |
