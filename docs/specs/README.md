...
| [Page, Document and Navigation Runtime Contract V1](page-navigation-runtime-contract-v1.md) | [Runtime FR #497](https://github.com/WebEnvoy/WebEnvoy/issues/497) | 冻结同一 Instance 内多 Page、document generation、popup/opener、URL/origin authorization、redirect、bounded close tombstone、receipt 与关系异常安全暂停语义。 |
...
| [Camoufox Native Provider Contract V1](camoufox-native-provider-contract-v1.md) | [Phase 1 native Camoufox validation #504](https://github.com/WebEnvoy/WebEnvoy/issues/504)、[Runtime FR #497](https://github.com/WebEnvoy/WebEnvoy/issues/497) | 定义 test-only Camoufox native snapshot、Playwright adapter、固定构件、Page relation、background create、safe-return close、reload 适配及兼容/回滚边界。 |
