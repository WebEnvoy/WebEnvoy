...
| [Grant Wire Contract V1 (v1.4)](grant-wire-contract-v1.md) | [Work Items #505](https://github.com/WebEnvoy/WebEnvoy/issues/505)、[#508](https://github.com/WebEnvoy/WebEnvoy/issues/508)、[#516](https://github.com/WebEnvoy/WebEnvoy/issues/516)、[#544](https://github.com/WebEnvoy/WebEnvoy/issues/544) | 固定 recovery、SKILL/file scope、Provider preference、`scope_semantics`、owner确认、版本兼容和旧严格 reader 拒绝边界。 |
