...
| [Capability Discovery and Operation Guidance V1](capability-discovery-v1.md) | [Work Item #539](https://github.com/WebEnvoy/WebEnvoy/issues/539)、[#474](https://github.com/WebEnvoy/WebEnvoy/issues/474) | 待审实施合同：单 operation 的静态规则与上下文说明、五维状态、只读无派发、单一参数定义、版本和验收；不表示已实现或新增执行权限。 |
