...
| [Form State and Target Actionability V1](form-state-actionability-v1.md) | [Work Item #555](https://github.com/WebEnvoy/WebEnvoy/issues/555)、[#497](https://github.com/WebEnvoy/WebEnvoy/issues/497)、[#474](https://github.com/WebEnvoy/WebEnvoy/issues/474) | Proposed 的 Observation/Plugin 专门补充：在可信 target 上冻结普通表单当前状态、目标级既有动作适用性、状态新鲜度、准确未派发拒绝、兼容与 S1—S8 验收；不新增 planner、权限或浏览器能力。 |
