...
- 后续归属/下一步：由调度线程在 WebEnvoy/Harbor#8、#9，WebEnvoy/Lode#6、#9，WebEnvoy/App#6、#9 与 Core #16/#341 之间收敛。实现前必须消费 ADR 0010，Core 继续“不复制其他仓 truth，只消费对外 refs / facts / intent”；字段/API 变化不得在 #341 docs-only PR 中猜测或落地。
