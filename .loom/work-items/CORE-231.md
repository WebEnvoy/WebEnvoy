...
- Shared `.loom/status/current.md` is active for CORE-231 while PR #240 is in review/merge; closeout or a follow-up retire PR must restore `no_active_item` after merge.
