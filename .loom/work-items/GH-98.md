...
- In scope: `packages/schemas/**`, root workspace scripts, `pnpm-lock.yaml` importer metadata, README schema self-check command, `.loom/work-items/GH-98.md`, `.loom/progress/GH-98.md`, `.loom/status/current.md`, and `.loom/specs/GH-98/*`.
