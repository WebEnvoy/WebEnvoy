...
export const managedOperations = ["profile.list", "profile.read", "profile.create", "instance.start", "instance.stop", "instance.observe", "instance.diagnostics", "environment.read", "environment.update", "instance.navigate", "instance.read", "instance.handoff", "account.bind", ...managedPageOperations, ...managedInteractionOperations] as const;
...
export type ManagedAccess = {
  ...
  /** Derived at admission; never persisted or accepted from the Agent. */
