...
const siteSpecs: readonly ReadOnlySiteSpec[] = [
  ...
  },
  {
    ...
    inputSummary: "Read a Xiaohongshu note detail from a signed note URL and xsec token ref.",
    inputRefs: ["https://www.xiaohongshu.com/explore/fixture-note-1?xsec_token=fixture", "input:fixture/xiaohongshu/read-note-detail"],
