...
export const supportedLodePackageRefs = [
  ...
  "lode://site-capability/xiaohongshu/publish-note-image-text-media@0.1.0",
  "lode://site-capability/xiaohongshu/publish-note-image-text-fields@0.1.1",
  "lode://site-capability/xiaohongshu/publish-note-image-text-commit@0.1.1",
...
export const retiredLodePackageRefs = new Set([
