...
const managedTaskScopeSchema = includeFileRefs => ({
  type: 'object',
  properties: { ...managedTaskScopeProperties, ...(includeFileRefs ? { file_refs: { type: 'array', items: { type: 'string', pattern: '^attachment:runtime/[0-9a-f-]{36}$' }, maxItems: 32 } } : {}) },
...
const managedOperationSchema = {
  ...
  properties: {
    ...
    task_scope: { type: 'object', properties: managedTaskScopeProperties, required: ['operations', 'profile_refs', 'origins'] },
