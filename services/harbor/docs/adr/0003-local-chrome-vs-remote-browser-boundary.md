...
> 2026-09-11：Provider 选择由 [Core ADR 0013](../../../../docs/adr/0013-provider-choice-and-obscura-validation.md) 继任：Provider 由用户选择，推荐／默认／Profile binding 分离；本 ADR 的所有权与数据边界继续有效。
