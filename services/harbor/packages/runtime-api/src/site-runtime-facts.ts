...
const SITE_PROFILES: Record<SiteRuntimeId, SiteResourceProfile> = {
  xiaohongshu: {
    ...
    write_precheck_task_kinds: new Set(["write_precheck", "publish_note_precheck", "xhs_publish_note_precheck", "publish_note_image_text_media", "publish_note_image_text_fields", "publish_note_image_text_commit"]),
