...
Provider 由用户在已支持、可用且获准的范围内选择；产品推荐、用户新建默认和 Profile 实际绑定分离。公共能力保持 provider-neutral，但不把中立语义变成由 WebEnvoy 补齐浏览器内核的义务。Obscura 在当前愿景内不采用；该方向以已合并的 [canonical 修订 .github#21](https://github.com/WebEnvoy/.github/pull/21) 为准。
